...
@Maven("https://raw.githubusercontent.com/apache/maven-resolver/97dfd1c2b9deb15734d5e401807e55cd0498332a/maven-resolver-util/src/test/java/org/eclipse/aether/util/version/GenericVersionTest.java")
public class GenericVersionTest extends AbstractVersionTest {
    ...
    public void testCaseInsensitiveOrderingOfQualifiersIsLocaleIndependent() {
        ...
        try {
            Locale[] locales = {Locale.ENGLISH, Locale.forLanguageTag("tr")};
